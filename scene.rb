module Sceane
    ...
    $image2 = Image.load("D:/Krasnacht/main/image/bottun1.jpg")
    $image3 = Image.load("D:/Krasnacht/main/image/bottun1.jpg")
    $image3.set_color_key(C_WHITE)
            
    bottun = Image.load("D:/Krasnacht/test2/image/bottun1.jpg")
    $bottun1 = Sprite.new(0,270,bottun)
    $sceane1 = Image.load("D:/Krasnacht/test2/image/BG00a1_80.jpg")
    hpg2 = Image.load("D:/Krasnacht/main/image/bottun1.jpg")
