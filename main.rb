...
class BattleScene
  ...
  def exec
    Window.draw_box_fill(0, 240, 480, 480, C_YELLOW) # y座標の修正
    Window.draw_scale(-160, -180, @sceane1, 0.6, 0.4) # 背景の描画
    @bottun1.draw
    Window.draw_font(50, 300, "逃げる", $font1, {:color=>C_BLACK})
    @hpg2.draw
    Window.draw_font(350, 300, "闘う", $font1, {:color=>C_BLACK})
    Window.draw(340, 100, @hpg)
    Window.draw_font(340, 100, "#{$enemy.hp}", $font1, {:color=>C_BLACK})
    $enemy.draw
